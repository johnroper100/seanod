            ...
            <?php foreach(getPages("newsItems", 0) as $newsItem) { if(isset($newsItem["content"]["featuredImage"])) {?>
                <div class="col-md-4 probootstrap-animate" data-animate-effect="fadeIn">
                    ...
                    <a href="<?php echo BASEPATH . '/' . $newsItem["collectionSubpath"] . '/' . $newsItem["path"]; ?>" class="img-bg"
                        style="background-blend-mode: multiply; background: rgba(0, 0, 0, 0.45); background-position: center; background-size: cover; background-image: url('<?php echo BASEPATH; ?>/uploads/<?php echo $imageDetails["fileSmall"]; ?>');">
